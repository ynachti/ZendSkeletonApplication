...
$settings = array(
    /*
     * if you change this to 1 'live' it will use the production wsdl service for user authentication
    * 2 : for test, 3 for development | Both use tst wsdl service
    */
    'environment' => 3, //production
    
    'wsdlenvironment' => 3, //development
    /*
     * BjyAuthorize uses this entitymanager value
     * Yeah I know it's confusing... zfcuser and bjyauthorize work together
     */
    'entitymanager' => 'doctrine.entitymanager.orm_production',
    
    'developmententitymanager' => 'doctrine.entitymanager.orm_application_development',

    'testentitymanager' => 'doctrine.entitymanager.orm_application_test',
     ...
     */
    'auth_adapters' => array( -200 => 'ZfcUser\Authentication\Adapter\Db' ),
     ...
     */
    'auth_identity_fields' => array( 'Nshe Id', 'L#', 'SSN'),
     ...
     */
    'user_login_widget_view_template' => 'zfc-user/user/template.phtml',
     ...
     */
    //'table_name' => 'user',
    'login_bypassers' => array('student/transcript'),
    /**
